...
|`$n`|если `n` это 1-2 значное число, то вставляет содержимое n-й скобки (см. главу [Скобочные группы](https://learn.javascript.ru/regexp-groups))|
|`$<name>`|вставляет содержимое скобки с указанным `name` (см. главу [Скобочные группы](https://learn.javascript.ru/regexp-groups))|
|`$$`|вставляет `"$"`|
...
2. `p1, p2, ..., pn` – содержимое скобок (см. главу [Скобочные группы](https://learn.javascript.ru/regexp-groups)).
3. `offset` – позиция, на которой найдено совпадение,
4. `input` – исходная строка,
5. `groups` – объект с содержимым именованных скобок (см. главу [Скобочные группы](https://learn.javascript.ru/regexp-groups)).
